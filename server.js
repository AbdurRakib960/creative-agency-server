...
admin.initializeApp({
  ...
  databaseURL: "https://creative-agency-33a1d.firebaseio.com",
});
...
const uri =
  `mongodb+srv://${process.env.DB_USER}:${process.env.DB_PASSWORD}@cluster0.tjyel.mongodb.net/${process.env.DB_NAME}?retryWrites=true&w=majority`;
